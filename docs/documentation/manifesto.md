...
_Version 1.0 of the Aragon Manifesto was originally published on the Aragon blog [here](https://blog.aragon.org/the-aragon-manifesto-4a21212eac03/)._
...
We consider this Manifesto **an alpha version**, and look forward to the [community's feedback](https://aragon.chat/) to evolve it over time to a definitive version.
